...
public class SettingsWidget extends Interfaces {
	...
	public static void widget(TextDrawingArea[] tda) {
		...
		configButton(42508, "Toggle roof visibility", 181, 180);
	...
	public static void controlsSettings(RSInterface controls, TextDrawingArea[] tda) {
		...
		configButton(FOLLOWER_OPTION, "Toggle follower options priority", 96, 95);
		
		configButton(41551, "Toggle Mouse Camera", 94,93);
		configButton(SHIFT_CLICK_DROP, "Toggle Shift Click Drop", 51, 50);
	...
	public static void updateSettings() {
		...
		RSInterface.interfaceCache[FOLLOWER_OPTION].active = Configuration.hidePetOptions;
	...
	public static final int SHIFT_CLICK_DROP = 41552;
	public static final int FOLLOWER_OPTION = 42553;
