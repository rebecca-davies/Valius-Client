...
public final class GameTimerHandler {
	...
	public void drawGameTimers(Client client, int x, int y) throws ParseException {
		...
		x -= drawingWidth;
		Raster.drawAlphaBox(x, y, drawingWidth, drawingHeight, 0x000000, Byte.MAX_VALUE / 2);
		Raster.drawAlphaBox(x, y, drawingWidth, 1, 0xCBBB99, 80);
		Raster.drawAlphaBox(x + drawingWidth - 1, y, 1, drawingHeight, 0xCBBB99, 80);
		Raster.drawAlphaBox(x, y + 1, 1, drawingHeight - 1, 0xCBBB99, 80);
		x += 2;
