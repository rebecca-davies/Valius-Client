...
public final class DepthImageProducer {
	...
	public DepthImageProducer(int canvasWidth, int canvasHeight) {
	...
	public void setCanvas() {
		Raster.initDrawingArea(this.canvasHeight, this.canvasWidth, this.canvasRaster);
	}
}
