...
public class Rasterizer2D extends Raster {
	...
	public static void initDrawingArea(int[] newPixels, int newWidth, int newHeight) {
		pixels = newPixels;
		width = newWidth;
		height = newHeight;
		setDrawingArea(0, 0, newWidth, newHeight);
	}
	...
	public static void fillCircleWithColors(int drawX, int drawY, int radius) {
		...
		for(int point = 0;point<720;point++) {
			...
			drawLineBetween(centerX, centerY, newX, newY, 0xf75904);
