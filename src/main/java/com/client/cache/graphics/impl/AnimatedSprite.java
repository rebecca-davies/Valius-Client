package com.client.cache.graphics.impl; /**
...
public final class AnimatedSprite extends Sprite
{
	...
	@Override
	public void method355(int[] src, int scanSize, int[] dir, int height, int dst[], int tmp, int dstOff, int dstPtr, int srcOff, int srcPtr)
	{
